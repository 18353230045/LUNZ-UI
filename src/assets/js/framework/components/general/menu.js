(function($) {
    ...
    var Plugin = {
      ...
      build: function() {
        ...
        if (Plugin.getSubmenuMode() === 'dropdown' || Plugin.isConditionalSubmenuDropdown()) {
          ...
          element.on(
            { mouseenter: Plugin.handleSubmenuDrodownHoverEnter, mouseleave: Plugin.handleSubmenuDrodownHoverExit },
        ...
        element
          .find('.m-menu__item:not(.m-menu__item--submenu) > .m-menu__link:not(.m-menu__toggle)')
          ...
          if (li.hasClass('m-menu__item--open') === false) {
            ...
            if (menu.options.accordion.expandAll === false) {
              var closables = item
                ...
                .find('> .m-menu__item.m-menu__item--open.m-menu__item--submenu:not(.m-menu__item--expanded)');
          ...
          if (check.apply() === true) {
            ...
            if (moved > 0) {
              submenu.find('> .m-menu__subnav > .m-menu__item').each(function() {
                ...
                element
                  .find('> .m-menu__nav > .m-menu__item:not(.m-menu__item--resize)')
                  .eq(elementsNumber - 1)
                  .after(item);
  ...
  $(document).on('click', function(e) {
    $('.m-menu__nav .m-menu__item.m-menu__item--submenu.m-menu__item--hover[data-menu-submenu-toggle="click"]').each(
      function() {
        var element = $(this)
          .parent('.m-menu__nav')
          .parent();
        ...
        if ($(e.target).is(element) == false && element.find($(e.target)).length == 0) {
          element
            .find('.m-menu__item--submenu.m-menu__item--hover[data-menu-submenu-toggle="click"]')
