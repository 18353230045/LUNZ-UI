    ...
    var datatable = $('.m_datatable').mDatatable({
      ...
      columns: [
              ...
              output =
                '<div class="m-card-user m-card-user--sm">\
								<div class="m-card-user__pic">\
									<img src="./assets/app/media/img/users/' +
                user_img +
                '" class="m--img-rounded m--marginless" alt="photo">\
								</div>\
        ...
        },
        {
          ...
          width: 150,
          template: function(data) {
            return '<a class="m-link" href="mailto:' + data.CompanyEmail + '">' + data.CompanyEmail + '</a>';
          }
        },
        {
          field: 'Status',
        ...
        },
        {
          ...
          overflow: 'visible',
          template: function(data) {
            var dropup = data.getDatatable().getPageSize() - data.getIndex() <= 4 ? 'dropup' : '';
